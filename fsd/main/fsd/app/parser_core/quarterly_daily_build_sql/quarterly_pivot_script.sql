DROP TABLE IF EXISTS Quarterly_Statements_i;
DROP TABLE IF EXISTS Quarterly_statements_p;
DROP TABLE IF EXISTS Quarterly_Statements_2;
DROP TABLE IF EXISTS Quarterly_Statements_3;
DROP TABLE IF EXISTS Quarterly_Statements_3v2;
DROP TABLE IF EXISTS Quarterly_Statements_4;
DROP TABLE IF EXISTS q_inconsistent_date_adjustment;
DROP TABLE IF EXISTS q_inconsistent_date_adjustment_2;
DROP TABLE IF EXISTS q_inconsistent_date_adjustment_3;
DROP TABLE IF EXISTS q_inconsistent_date_adjustment_4;
DROP TABLE IF EXISTS q_inconsistent_date_adjustment_5;
DROP TABLE IF EXISTS quarterly_statements_5;

CREATE TABLE Quarterly_Statements_i AS 
SELECT 
Ticker, 
Name, 
CIK, 
...
from tam_with_count_unstable_Q
group by
Ticker, 
Name, 
CIK, 
...
CREATE TABLE Quarterly_Statements_p AS 
SELECT 
Ticker, 
Name, 
CIK, 
...
DROP TABLE IF EXISTS Quarterly_Statements_2;
CREATE TABLE Quarterly_Statements_2 AS 
select
Ticker, 
Name, 
CIK, 
...
DROP TABLE IF EXISTS Quarterly_Statements_3;
CREATE TABLE Quarterly_Statements_3 AS 
select
Ticker, 
Name, 
CIK, 
...
CREATE TABLE quarterly_statements_4 AS
SELECT
a.Ticker, 
a.Name, 
a.CIK, 
...
FROM
quarterly_statements_3 b
INNER JOIN
quarterly_statements_2 a
...
CREATE TABLE IF NOT EXISTS q_inconsistent_date_adjustment AS
SELECT 
a.report_id,
a.end_date,
b.instant_date
...
CREATE TABLE IF NOT EXISTS q_inconsistent_date_adjustment_2 AS
SELECT
*,
...
CREATE TABLE IF NOT EXISTS q_inconsistent_date_adjustment_3 AS
SELECT 
Ticker, 
Name, 
CIK, 
...
FROM quarterly_statements_3 b;

CREATE TABLE IF NOT EXISTS q_inconsistent_date_adjustment_4 AS
SELECT
*
FROM q_inconsistent_date_adjustment_3
WHERE
report_id IN
	(SELECT 
	 report_id
	 FROM q_inconsistent_date_adjustment_2
	 WHERE date_comp IN ('priority_i','priority_p'));
	 
CREATE TABLE IF NOT EXISTS q_inconsistent_date_adjustment_5 AS
SELECT
Ticker, 
Name, 
CIK, 
...
inventorynet,
researchanddevelopmentexpense
FROM  q_inconsistent_date_adjustment_4;

CREATE TABLE IF NOT EXISTS quarterly_statements_5 AS
SELECT
a.*
...
SELECT 
b.*
FROM q_inconsistent_date_adjustment_5 b
ORDER BY
a.ticker asc,
a.cik2,
a.submission_date desc;
