...
try:
    with open(BASE_DIR / "secrets.json") as key_file:
...
SECURE_SSL_REDIRECT = True if not APPLICATION_UNDER_TEST else False

SESSION_COOKIE_SECURE = True if not APPLICATION_UNDER_TEST else False
